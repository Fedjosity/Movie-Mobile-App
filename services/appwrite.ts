...
export const updateSearchCount = async (query: string, anime: Anime) => {
  // TODO: Re-enable Appwrite analytics
  ...
  //   const existingAnime = result.documents[0];
  //   await database.updateDocument(
  //     DATABASE_ID,
  //     COLLECTION_ID,
  //     existingAnime.$id,
  //     { count: existingAnime.count + 1 }
  //   );
  // } else {
